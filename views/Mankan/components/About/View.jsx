...
import { mankanProjectList } from './Constants/constants';
            ...
            {mankanProjectList.map(({ id, title, description, Icon }) => (
              <div key={id} className={`col_ ${styles['widget-overlay']}`}>
                <div className={styles['about-widget']}>
                  ...
                  <div className={styles['widget-icon']}>{Icon}</div>
                </div>
              </div>
            ))}
          </div>
